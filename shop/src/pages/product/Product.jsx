...
getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
  ...
  updateProduct(downloadURL)&& window.location.replace("/products")
      ...
      <div className="productBottom">
        <form className="productForm">
          ...
          <div className="productFormRight">
            ...
            <button className="productButton" onClick={handleClick}> <Link style={{ color:"white", textDecoration: "none",padding:"0 50px", animationDelay: "5s"}} to="/products">Update</Link></button>
          </div>
        </form>
